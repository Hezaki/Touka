{ config, ... }:
{
  home.file."Documents/main/.obsidian/themes/Stylix/manifest.json".text = with config.lib.stylix.colors; ''
    {
       "name": "Stylix",
       "version": "1.1.1",
       "minAppVersion": "1.1.1",
  ...
  '';
  home.file."Documents/main/.obsidian/themes/Stylix/theme.css".text = with config.lib.stylix.colors; ''
    .theme-dark,
    .theme-light{
      /* Actual colors*/
